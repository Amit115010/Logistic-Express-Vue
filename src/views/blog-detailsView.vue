...
import CategorylisComponents from "../components/categorylisComponents.vue";
import RecentPostComponent from "../components/recentPostComponent.vue";
import TagwidgetComponent from "../components/tagwidgetComponent.vue";
import InstagramFeedComponent from "../components/instagramFeedComponent.vue";
import NewslatterWidgetComponent from "../components/newslatterWidgetComponent.vue";
import SearchWidgetComponent from "../components/searchWidgetComponent.vue";
</script>
<template>
  <main>
    <!--? slider Area Start-->
    <div class="slider-area">
      <div
        ...
        data-background="src/assets/img/hero/about.jpg"
      >
        <div class="container">
          <div class="row">
            <div class="col-xl-12">
          ...
          <div class="col-lg-8 posts-list">
            <div class="single-post">
              <div class="feature-img">
                <img
                  class="img-fluid"
                  src="src/assets/img/blog/single_blog_1.png"
                  alt=""
                />
              </div>
                  ...
                  >
                    <div class="thumb">
                      <a href="#">
                        <img
                          class="img-fluid"
                          src="src/assets/img/post/preview.png"
                          alt=""
                        />
                      </a>
                    </div>
                  ...
                  >
                    ...
                    <div class="thumb">
                      <a href="#">
                        <img
                          class="img-fluid"
                          src="src/assets/img/post/next.png"
                          alt=""
                        />
                      </a>
                    </div>
            ...
            <div class="blog-author">
              <div class="media align-items-center">
                <img src="src/assets/img/blog/author.png" alt="" />
            ...
            <div class="comments-area">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="src/assets/img/comment/comment_1.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="src/assets/img/comment/comment_2.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
                        Multiply sea night grass fourth day sea lesser rule open
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="src/assets/img/comment/comment_3.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
                        Multiply sea night grass fourth day sea lesser rule open
