  ...
  <main>
    ...
    <section class="sample-text-area">
      <div class="container box_1170">
        ...
        <p class="sample-text">
          ...
          creative prowess. Many have great ideas and want to “wow” the<sup
            >Superscript</sup
          >
    ...
    <section class="button-area">
      <div class="container box_1170 border-top-generic">
        ...
        <div class="button-group-area mt-40">
          <a href="#" class="genric-btn default circle arrow"
          ...
          ></a>
          <a href="#" class="genric-btn success circle arrow"
            >Success<span class="lnr lnr-arrow-right"></span
          ></a>
          <a href="#" class="genric-btn info circle arrow"
            >Info<span class="lnr lnr-arrow-right"></span
          ></a>
          <a href="#" class="genric-btn warning circle arrow"
